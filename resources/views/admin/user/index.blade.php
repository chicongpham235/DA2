...
<div class="row mt-2">
  ...
  <div class="col">
    <a href="{{route('admin.user.create')}}" class="btn btn-primary float-right">Thêm mới</a>
  </div>
</div>
<hr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        @elseif ($user->level==1)
        <span class="badge badge-primary">Người quản lý</span>
        @elseif ($user->level==2)
      ...
      <td class='text-right'>
        ...
        <a href="{{route('admin.user.destroy',$user->id)}}" class="btn btn-sm btn-danger btndelete">
