                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-6">
                            <div class="checkout__order">
                                ...
                                <div class="checkout__order__subtotal">Subtotal <span>{{ number_format(Cart::subtotal(0)) }}đ</span></div>
                                <div class="checkout__order__total">Total <span> {{number_format(Cart::Total()) }}đ</span></div>
